...
if ($backups->is_disabled()) {
	...
	$confirm = esc_html__(
		'IMPORTANT: The import demo tool will download content from our Webzakt.com server and install it onto your site.'
		. 'Installing this demo content will delete the content you currently have on your website.'
